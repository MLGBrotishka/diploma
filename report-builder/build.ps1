...
&$exe $flags $md -o $tempdocx --lua-filter ./linebreaks.lua --filter pandoc-crossref --citeproc --reference-doc $template
...
$bullets = [char]0x2014,[char]0x2014,[char]0x2014,[char]0x2014
